    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Edit Acara</h1>
                ...
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-gray-500">Edit Acara</li>
                </ul>
            </div>
...
@section('content')
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <!--begin::Form-->
            <form action="{{ route('acara.update', $acara->id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
                @csrf
                @method('PUT')
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <textarea name="deskripsi" rows="4" class="form-control"
                                          placeholder="Tuliskan informasi tambahan acara...">{{ old('deskripsi', $acara->deskripsi) }}</textarea>
                            </div>
