            ...
            <div class="card card-flush border-0 shadow-sm rounded-4">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        <!--begin::Search-->
                         <h2><i class="bi bi-person-vcard-fill fs-2 text-primary me-2"></i>BIODATA</h2>
                        <!--end::Search-->
                    </div>
                    <!--end::Card title-->
                    <!--begin::Card toolbar-->
                               ...
                               <div class="separator border-primary my-10"></div>
                                ...
                                <div class="row fs-2 text-center mb-5">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <p class="text-primary small m-0">NIK</p>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <i class="bi bi-calendar-date-fill text-primary fs-2 me-2"></i>
                                        ...
                                        <p class="text-primary small m-0">Tanggal Lahir</p>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        @if ($profile->jenis_kelamin == 'laki-laki')
                                            <i class="bi bi-gender-male fs-2 text-primary me-2"></i>
                                        @else
                                            <i class="bi bi-gender-female fs-2 text-primary me-2"></i>
                                        @endif

                                        <span id="data-jk" class="fw-medium text-dark">{{ ucfirst($profile->jenis_kelamin) }}</span>
                                        <p class="text-primary small m-0">Jenis Kelamin</p>
                                    </div>
                                </div>
                                ...
                                <div class="row fs-2 text-center mb-5">
                                    <div class="col-md-6 mb-3">
                                        @if ($profile->status_pernikahan == 'Kawin')
                                            <i class="bi bi-heart-fill fs-2 text-primary me-2"></i>
                                        @else
                                            <i class="bi bi-heartbreak-fill fs-2 text-primary me-2"></i>
                                        @endif

                                        <span id="data-status" class="fw-medium text-dark">{{ $profile->status_pernikahan }}</span>
                                        <p class="text-primary small m-0">Status Pernikahan</p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        @if ($profile->disabilitas == 'iya')
                                            <i class="bi bi-person-wheelchair fs-2 text-primary me-2"></i>
                                        @else
                                            <i class="bi bi-person-walking fs-2 text-primary me-2"></i>
                                        @endif
                                        <span id="data-disabilitas" class="fw-medium text-dark">{{ ucfirst($profile->disabilitas) }}</span>
                                        <p class="text-primary small m-0">Disabilitas</p>
                                    </div>
                                </div>

                                <!-- Alamat Lengkap -->
                                <div class="text-center fs-2 mb-5">
                                    ...
                                    <p class="text-primary small m-0">Alamat Lengkap</p>
                                </div>

                                <div class="separator border-primary my-10"></div>
                                <!-- Bagian Dokumen -->
                                <h1 class="fw-bold text-dark mb-3 fs-2 text-center">
                                    <i class="bi bi-archive-fill fs-2 text-primary me-2"></i>
                                    Dokumen Pelamar
                                </h1>
                                <div class="row text-center">
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-credit-card-fill fs-2 me-2 text-primary"></i>
                                    ...
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-file-earmark-zip-fill     fs-2 me-2 text-primary"></i>
                                    ...
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-mortarboard-fill fs-2 me-2 text-primary"></i>
                                    ...
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-briefcase-fill fs-2 me-2 text-primary"></i>
                                    ...
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-award-fill fs-2 me-2 text-primary"></i>
                                    ...
                                    <div class="col-md-12 m-10">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-clipboard-plus-fill fs-2 me-2 text-primary"></i>
