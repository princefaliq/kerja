<!-- start section -->
<section class="bg-dark-midnight-blue background-position-right-top background-no-repeat md-background-image-none" style="background-image: url('logo/demo-conference-about-bg.png')">
    {{--<div class="container-fluid d-none d-md-block">
        <div class="row">
            <div class="p-0 overlap-section text-end pe-4 md-pe-5">
                <img src="{{ url('logo/demo-conference-02.png') }}" alt="" class="animation-rotation lg-w-120px">
            </div>
        </div>
    </div>--}}
    <div class="container">
        <div class="row align-items-center justify-content-center">
                ...
                <figure class="position-relative mb-50px sm-ps-50px">
                    <div class="overflow-hidden border-radius-4px position-relative">
                        <div class="w-100" data-anime='{ "effect": "slide", "direction": "bt", "color": "#17161a", "duration": 1000, "delay": 0 }'>
                            <img src="{{ url('logo/tentang.jpg') }}" alt="" class="w-100 border-radius-5px liquid-parallax" data-parallax-liquid="true" data-parallax-position="top" data-parallax-scale="1.2">
                        </div>
                    </div>
            ...
            <div class="col-xl-4 offset-lg-1 col-md-10 col-lg-5" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <h2 class="alt-font text-white fw-500 ls-minus-2px mb-40px sm-mb-30px">
                    <span class="w-20px h-4px d-inline-block bg-base-color me-10px"></span>Kerja Berkah
                </h2>
                ...
                <div class="icon-with-text-style-01 mb-30px pb-30px border-bottom border-color-transparent-white-light">
                    <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                        ...
                        <div class="feature-box-content">
                            <span class="d-inline-block alt-font text-white fs-20">Pencarian kerja cepat</span>
                        </div>
                        <div class="mt-10px w-100">Dengan fitur pencarian yang efisien, pengguna dapat menemukan berbagai peluang kerja sesuai keahlian dalam waktu singkat</div>
                    </div>
                </div>
                ...
                <div class="icon-with-text-style-01 mb-40px md-mb-30px">
                    <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                        ...
                        <div class="feature-box-content">
                            <span class="d-inline-block alt-font text-white fs-20">Rekruitmen Transparan</span>
                        </div>
                        <div class="mt-10px w-100">Aplikasi ini memastikan bahwa setiap tahap rekrutmen diinformasikan secara jelas, sehingga pencari kerja dapat memahami kriteria dan proses yang dihadapi</div>
                    </div>
                </div>
                <!-- end features box item -->
                {{--<a href="/" class="btn btn-large btn-dark-gray btn-hover-animation btn-round-edge btn-box-shadow align-self-center">
                            <span>
                                <span class="btn-text">Tentang Kerja Berkah</span>
